...
- Added API/client recovery hints for common local contract failures such as missing policy, caps, utilization, private balance, used commitments/nullifiers, and dead RPCs.
